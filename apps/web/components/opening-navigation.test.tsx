...
it('a fresh workspace discovers and reenters persisted preparation without a draft save or CREATE', async () => {
  ...
  vi.mocked(createGenerationClient).mockReturnValue({history:{recover:vi.fn(),list:vi.fn(),get:vi.fn(),fork:vi.fn(),resume:vi.fn()},get,beginPlayback:vi.fn(),reportPlayback:vi.fn(),quote:vi.fn(),accept:vi.fn(),getQuote:vi.fn(),completePlayback:vi.fn(),getDraft:vi.fn(),saveDraft:vi.fn()});
